...
/**
 * Servlet implementation class EditQAActionServlet
 */

public class EditQAActionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditQAActionServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Question question = Question.getById(Integer.valueOf(questionId));
